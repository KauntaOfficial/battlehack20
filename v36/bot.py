...
def turn():
    ...
    if robottype == RobotType.PAWN:
        ...
        if check_space_wrapper(row + (forward * -1), col + 1, board_size) != team and check_space_wrapper(row + (forward * -1), col - 1, board_size) != team:
            push = False
        ...
        col_to_place = 7
        max_col_threat = threat_level[col_to_place]
